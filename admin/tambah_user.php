<?php
/**
 * Halaman Tambah User - Admin Perpustakaan Digital Gamifikasi
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows > 0) {
        ...
        // Insert user
        $query = "INSERT INTO users (nama, email, password, kelas, jurusan, role, avatar, xp, level, is_active) 
                  VALUES (?, ?, ?, ?, ?, ?, 'default-avatar.png', 0, 1, 1)";
        $stmt = $conn->prepare($query);
        $stmt->bind_param("ssssss", $nama, $email, $password, $kelas, $jurusan, $role);
        
        if ($stmt->execute()) {
            $new_user_id = $conn->insert_id;
            
            // Jika role admin, tambahkan ke admin_details
            if ($role == 'admin' && $check_admin_table->num_rows > 0) {
                ...
                $query_details = "INSERT INTO admin_details (user_id, nip, jabatan, no_telp, alamat, akses_level) 
                                  VALUES (?, ?, ?, ?, ?, ?)";
                $stmt_details = $conn->prepare($query_details);
                $stmt_details->bind_param("isssss", $new_user_id, $nip, $jabatan, $no_telp, $alamat, $akses_level);
                $stmt_details->execute();
            }
...
$page_title = "Tambah User - Admin Perpustakaan";
?>
    ...
    <main class="main-container">
        <div class="form-card" data-aos="fade-up">
            <div class="form-header">
                ...
                <p>Tambahkan user baru (siswa atau admin) ke sistem</p>
            </div>
            ...
            <form method="POST" action="" id="tambahUserForm">
                <div class="form-grid">
                    ...
                    <!-- Siswa Fields -->
                    <div id="siswaFields" style="display: none;" class="full-width">
                        <div class="form-grid">
                            <div class="form-group">
                                <label for="kelas">
                    ...
                    <!-- Admin Fields -->
                    <div id="adminFields" style="display: none;" class="admin-fields">
                        <h3>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <select class="form-control" id="akses_level" name="akses_level">
                                        <option value="admin_perpus">Admin Perpustakaan</option>
                                        <option value="super_admin">Super Admin</option>
                                        <option value="admin_teknis">Admin Teknis</option>
                                    </select>
                                </div>
                            </div>
    ...
    <script>
        ...
        document.addEventListener('keydown', function(e) {
            ...
            if (e.ctrlKey && e.key === 's') {
                e.preventDefault();
                document.getElementById('tambahUserForm').submit();
            }
        });
    </script>
</body>
